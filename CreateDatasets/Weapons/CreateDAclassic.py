...
# Rutas
data_dir = "/mnt/homeGPU/azapata/TFG/datasets/gunsUGR/OD-WeaponDetection-master/Weapons_and_similar_handled_objects/Sohas_weapon-Detection-YOLOv5/obj_train_data"
augmented_dir = "/mnt/homeGPU/azapata/TFG/datasets/gunsUGR/OD-WeaponDetection-master/Weapons_and_similar_handled_objects/Sohas_weapon-Detection-YOLOv5/obj_train_data/weapons_DA_classic"
...
for img_name in os.listdir(image_dir):
    ...
    dest_img_path = os.path.join(augmented_dir, "images", img_name)
    ...
    aug_img_path = os.path.join(augmented_dir, "images", aug_img_name)
    ...
    dst_label_path = os.path.join(augmented_dir, "labels", label_name)

    if os.path.exists(src_label_path):
        shutil.copy(src_label_path, dst_label_path)

        # También duplicar la etiqueta para la imagen aumentada
        aug_label_path = os.path.join(augmented_dir, "labels", label_name.replace(".txt", "_aug.txt"))
