...
dataset_yaml = "/mnt/homeGPU/azapata/TFG/datasets/coco/coco100DADM.yaml"
...
print("🚀 Iniciando el entrenamiento de YOLOv8 con el 100% del dataset COCO más los datos con DA DM")
try:
